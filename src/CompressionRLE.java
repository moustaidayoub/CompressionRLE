...
public CompressionRLE() throws IOException
{
Initializer("rle.png");
algorithme();
    ...
    private void Initializer(String url)
    {
        ...
        try {
        image = ImageIO.read(new File(getClass().getResource(url).toURI()));
        } 
        catch (IOException e) {
        System.out.println(e.getMessage());
        } 
        catch (URISyntaxException ex) {
        Logger.getLogger(CompressionRLE.class.getName()).log(Level.SEVERE, null, ex);
        }
